                            ...
                            @if($student->status !== 'approved')
                                <label class="block text-sm font-semibold text-slate-600">
                                    ...
                                    <textarea
                                        ...
                                        class="mt-2 w-full rounded-[1.25rem] border border-[#d5e0f0] bg-white px-4 py-3 text-sm text-slate-700 outline-none transition placeholder:text-slate-400 focus:border-[#1e4fa3]"
                                    ></textarea>
                                </label>
                            @endif
