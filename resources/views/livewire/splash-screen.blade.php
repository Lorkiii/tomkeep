...
<div class="flex min-h-screen flex-col items-center justify-center bg-white" x-data="{
        visible: false,
    ...
    <div x-show="visible" x-transition:enter="transition ease-out duration-500"
        ...
        <div class="h-24 w-24 shrink-0 rounded-full bg-white sm:h-28 sm:w-28"
            style="box-shadow: 4px 4px 12px rgba(0,0,0,0.08);"></div>
