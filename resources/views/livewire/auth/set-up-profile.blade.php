{{-- Profile setup form used to collect required student details before dashboard access. --}}
<div>
    ...
    <x-ojt-card heading="Set Up Your Profile" maxWidth="max-w-md" headingClass="text-slate-500 font-medium">
        ...
        <form wire:submit="openConfirmation" class="space-y-3">
            <!-- First Name -->
            <div>
                <label for="profile-first-name" class="block text-sm font-medium text-slate-700">First Name <span
            ...
            <!-- Middle Name -->
            <div>
                <label for="profile-middle-name" class="block text-sm font-medium text-slate-700">Middle Name <span
                        class="text-red-500">*</span></label>
            ...
            <!-- Last Name -->
            <div>
                <label for="profile-last-name" class="block text-sm font-medium text-slate-700">Surname <span
                        class="text-red-500">*</span></label>
            ...
            <!-- Gender -->
            <div>
                <label for="profile-gender" class="block text-sm font-medium text-slate-700">Gender <span
                        class="text-red-500">*</span></label>
            ...
            <div>
                ...
                @if(!empty($locationLoadError))
                    <p class="mb-2 text-xs text-red-600">{{ $locationLoadError }}</p>
                @endif
                ...
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <select id="profile-province" wire:model.live="province_code"
                    ...
                    <div>
                        ...
                        <select id="profile-municipality" wire:model.live="municipality_code"
                            ...
                            @if($province_code === '' || $province_code === null) disabled @endif>
                        ...
                        @endif
                        @error('municipality_code')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        <p class="mt-1 text-xs text-slate-500">Barangay</p>
                        <select id="profile-barangay" wire:model.live="barangay_code"
                            class="w-full rounded-lg border border-slate-200 bg-white py-2.5 px-4 text-slate-800 focus:border-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-400 disabled:bg-slate-100 disabled:text-slate-500"
                            @if($province_code === '' || $province_code === null) disabled @endif>
                            @foreach($barangayOptions ?? [] as $value => $label)
                                <option value="{{ $value }}">{{ $label }}</option>
                            @endforeach
                        </select>
                        @error('barangay_code')
                    ...
                    <div>
                        <p class="mt-1 text-xs text-slate-500">Street / House Number</p>
                        <input id="profile-street/house-number" type="text" wire:model="street_house_number"
            ...
            <div>
                <label for="profile-required-hours" class="block text-sm font-medium text-slate-700">No. of Hours <span
                        class="text-red-500">*</span></label>
                <input id="profile-required-hours" type="number" wire:model="required_hours" min="1" max="9999"
                    class="mt-1 w-full rounded-xl border border-slate-200 py-2.5 px-4 text-slate-800 placeholder-slate-400 focus:border-slate-400 focus:outline-none focus:ring-1 focus:ring-slate-400"
                    placeholder="e.g. 350" />
            ...
            <div>
                <label for="profile-contact-number" class="block text-sm font-medium text-slate-700">Contact Number
            ...
            <div>
                <label for="profile-school-attended" class="block text-sm font-medium text-slate-700">University
            ...
            <div class="pt-2">
                <button type="submit" style="background-color: #1f4082;"
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" role="dialog" aria-modal="true"
            ...
            <div class="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-6 shadow-xl">
                ...
                <div class="mt-4 flex gap-4">
                    <div
                        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-blue-100 text-[#1e3a5f]">
                ...
                <div class="mt-6 flex gap-3">
                    ...
                    <button type="button" wire:click="submitProfile"
            ...
            <div class="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-6 shadow-xl">
                ...
                <div class="mt-4 flex gap-4">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-1 text-sm text-slate-600">The system received your account creation request. Please
                            wait for confirmation message on your email.</p>
                    </div>
                </div>
                <div class="mt-6">
                    <button type="button" wire:click="closeSuccess"
