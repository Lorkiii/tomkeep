...
class TodayAttendanceTable extends Component
{
    ...
    public function render(AttendanceMetrics $metrics)
    {
        ...
        $records = $query->paginate(self::PER_PAGE, [
            ...
            'daily_time_records.time_in_latitude',
            'daily_time_records.time_in_longitude',
            'daily_time_records.lunch_out',
            'daily_time_records.lunch_in',
            'daily_time_records.time_out',
            'daily_time_records.time_out_latitude',
            'daily_time_records.time_out_longitude',
            'users.student_code',
            'users.first_name',
            'users.middle_name',
            'users.last_name',
        ...
        $rows = $records->through(function ($record) use ($metrics): array {
            ...
            return [
                ...
                'time_in_latitude' => $data['time_in_latitude'] ?? null,
                'time_in_longitude' => $data['time_in_longitude'] ?? null,
                'lunch_out' => $data['lunch_out'] ?? null,
                'lunch_in' => $data['lunch_in'] ?? null,
                'time_out' => $data['time_out'] ?? null,
                'time_out_latitude' => $data['time_out_latitude'] ?? null,
                'time_out_longitude' => $data['time_out_longitude'] ?? null,
